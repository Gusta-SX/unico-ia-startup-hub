        ...
        <CarouselContent>
          {campaignData.map((campaign) => (
            <CarouselItem key={campaign.id}>
              <Card className="overflow-hidden rounded-xl border-0 h-48">
                <div className="relative w-full h-full">
                  ...
                  <div className="absolute inset-0 p-6 flex flex-col justify-between">
                    <div>
                      ...
                      <p className="text-white/80 mt-2 max-w-[80%]">{campaign.description}</p>
                    </div>
                    <div>
                      <button className="bg-white/20 hover:bg-white/30 text-white px-4 py-2 rounded-lg backdrop-blur-sm transition-all">
                        Saiba mais
                      </button>
                    </div>
                  </div>
